var MeruLogo = (function (window) {
    ...
    var options = {
        ...
        shadowCanvasID: null,
        wordImageURL: "/assets/themes/dwtalk/img/meru-word.png",
        wordOffsetX: -25,
        wordOffsetY: 0,
        wordScale: 1,
    ...
    API.initialize = function (overrideOptions) {
        ...
        logoCanvas = $("#" + options.logoCanvasID)
            .get(0);
        shadowCanvas = $("#" + options.shadowCanvasID)
            .get(0);
    ...
    function enableDebugging() {
        ...
        $("#debug-panel textarea")
            .text(configureScript);
        $("#debug-panel .run")
            .click(function (event) {
            event.preventDefault();
            eval($("#debug-panel textarea")
                .val())
        });
        $("#debug-panel .save")
            .click(function (event) {
    ...
    function updateColor() {
		...
		if (targetColor != rgbToHex(shapeForegroundColorTarget.r, shapeForegroundColorTarget.g, shapeForegroundColorTarget.b)) {
			...
			$("#geek").animate({color: targetColor},0.015 * options.colorSpeedFactor * performance.factor * turboColorSpeedFactor * 300000);
		}	
